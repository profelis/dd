...
class PerlinShader extends Shader
{
    ...
    function initPermut()
    {
        ...
        var t = c.createTexture(256, 256, Context3DTextureFormat.BGRA, false);
        t.uploadFromByteArray(permutBytes, 0);
        return t;
    }
    ...
    function initGradient()
    {
        ...
        var t = c.createTexture(256, 1, Context3DTextureFormat.BGRA, false);
        t.uploadFromByteArray(permutBytes, 0);
        return t;
    }

    public function perlin( delta:Vector3D, scale : Float, mpos:Matrix3D, mproj:Matrix3D, cTrans:Vector3D)
    {
